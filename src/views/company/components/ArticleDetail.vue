        ...
        <el-row>
          <el-col :span="6">
            <el-form-item
              ...
              prop="background_image_uri"
            >
              <MDinput
                v-model="postForm.background_image_uri"
                :maxlength="200"
                name="name"
                required
              >
          ...
          <el-col :span="18">
            ...
            >
              <Upload v-model="postForm.background_image_uri" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
...
<script>
import { fetchCompany, updateCompanyInfo } from "@/api/company";
  ...
  methods: {
    ...
    submitForm() {
      this.$refs.postForm.validate(valid => {
        if (valid) {
          updateCompanyInfo(this.postForm).then(() => {
